...
def obter_cotacoes_ceasa_via_scrapingbee():
    ...
    try:
        ...
        # Etapa 1: Acessar a página inicial com configurações otimizadas
        ...
        params = {
            ...
            "country_code": "br",
            "render_js": True,
            "wait": 3000  # Esperar 3 segundos para carregar completamente
        }
        ...
        # Etapa 4: Acessar a página do boletim completo com configurações otimizadas
        params = {
            "api_key": scrapingbee_api_key,
            ...
            "country_code": "br",
            "render_js": True,
            "wait": 5000,  # Esperar 5 segundos para carregar completamente
            "wait_for": ".tabela"  # Esperar até que a tabela esteja disponível
        }
